...
CREATE TABLE  `Usuarios`(
    ...
    `Numero_Celular` INT(10) NOT NULL UNSIGNED UNIQUE,
...
CREATE TABLE `Pagos`(
    ...
    `Estado` BOOLEAN NOT NULL FALSE,
    `Metodo_Pago` VARCHAR(30) NOT NULL,
    `Valor_Pago` DECIMAL(7,3) NOT NULL UNSIGNED,
    `Create_at` TIMESTAMP NOT NULL DEFAULT NOW,

    PRIMARY KEY (Serial_Pago)
    FOREIGN KEY(Factura INT(15) NOT NULL),
),

CREATE TABLE `Factura`(
    `id` INT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
    `Cantidad` INT NOT NULL UNSIGNED,
    `Sub_Total` DECIMAL(7,3) NOT NULL UNSIGNED,
    `Total_Factura` DECIMAL(7,3) NOT NULL UNSIGNED,
    `Created_at` TIMESTAMP NOT NULL DEFAULT NOW,
    `Updated_at` TIMESTAMP NOT NULL DEFAULT NOW,

    PRIMARY KEY(id),

    FOREIGN KEY(Usuarios_id BIGINT(20) UNSIGNED NOT NULL),
...
CREATE TABLE `Productos`(
    ...
    FOREIGN KEY(Factura_id INT(20) UNSIGNED NOT NULL),  
),
...
CREATE TABLE `Blogposts`(
    ...
    `Fecha_Publicación` TIMESTAMP NOT NULL DEFAULT NOW,
    `Contenido` TEXT,
    `Estado` BOOLEAN NOT NULL DEFAULT FALSE,
    `Updated_at` TIMESTAMP NOT NULL DEFAULT NOW,
